...
class CornersProblem(search.SearchProblem):
    ...
    def isGoalState(self, state: Any):
        ...
        #         print(self.corners, self.startingCornerState.visited, state, 'CORNERS')
        #         self.startingCornerState.visited[i] = True
        # return False not in  self.startingCornerState.visited
        # print(state[1:], '{}{}{}{}{}{')
        # for t in state[1:]:
        #     print(t)
        #     if t is False:
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    for i in range(foodGrid.height):
        for j in range(foodGrid.width):
            if foodGrid[j][i]:
                heuristic_value = max(heuristic_value, mazeDistance((j, i), position, NewState(state, problem.walls)))
